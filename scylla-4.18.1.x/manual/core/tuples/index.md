...
* getting hold of the [TupleType](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/type/TupleType.html): statement or session metadata, `tupleValue.getType()`, or
  `DataTypes.tupleOf()`.
* creating a value from a type: `tupleType.newValue()`.

---

[CQL tuples](https://docs.datastax.com/en/cql/3.3/cql/cql_reference/tupleType.html) are ordered sets of anonymous, typed fields. They can be used as a column type
in tables, or a field type in [user-defined types]():
...
The driver maps tuple columns to the [TupleValue](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/data/TupleValue.html) class, which exposes getters and setters to access
...
To create a new tuple value, you must first have a reference to its [TupleType](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/type/TupleType.html). There are various
ways to get it:
