...
* [DriverConfigLoader.fromClasspath](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html#fromClasspath-java.lang.String-): still load from the classpath, but use a different resource
  name. For example “config” will try to load `config.conf`, `config.json` or `config.properties`.
* [DriverConfigLoader.fromFile](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html#fromFile-java.io.File-): load from a file on the local filesystem.
* [DriverConfigLoader.fromUrl](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html#fromUrl-java.net.URL-): load from a URL.
...
Alternatively, you can use [DriverConfigLoader.programmaticBuilder](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html#programmaticBuilder--) to specify configuration options
...
The driver’s context exposes a [DriverConfig](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/config/DriverConfig.html) instance:
...
[DriverExecutionProfile](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/config/DriverExecutionProfile.html) has typed option getters:
...
Next, you will need to provide your own implementations of [DriverConfig](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/config/DriverConfig.html) and
...
Where [DriverContext](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/context/DriverContext.html) is the object returned by `session.getContext()`, which allows the policy to
...
First, write an enum that implements [DriverOption](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/config/DriverOption.html):
