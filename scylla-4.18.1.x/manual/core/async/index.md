...
[AsyncResultSet](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/AsyncResultSet.html) that only iterates the current page, the next pages must be fetched explicitly.
