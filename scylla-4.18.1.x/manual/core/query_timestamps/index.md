...
* programmatically with [Statement.setQueryTimestamp()](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/Statement.html#setQueryTimestamp-long-).
...
You can create your own generator by implementing [TimestampGenerator](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/time/TimestampGenerator.html), and referencing your
