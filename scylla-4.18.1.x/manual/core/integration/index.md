...
[CqlSession.builder().addContactPoint()](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#addContactPoint-java.net.InetSocketAddress-) to use a different
address).
...
* to get the process ID when generating [UUIDs](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/uuid/Uuids.html).
...
if you are using a different metrics library, and you never call [Session.getMetrics](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/session/Session.html#getMetrics--) anywhere in
