...
* can be overridden per statement [Statement.setIdempotent](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/Statement.html#setIdempotent-java.lang.Boolean-) or [StatementBuilder.setIdempotence](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/StatementBuilder.html#setIdempotence-java.lang.Boolean-).
...
* [retries](): if we’re waiting for a response from a node and the connection gets
  ...
  retried.
* [speculative executions](): if they are enabled and a node takes too long
