...
You don’t need to manage connections yourself. You simply interact with a [CqlSession](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/CqlSession.html) object, which
takes care of it.
