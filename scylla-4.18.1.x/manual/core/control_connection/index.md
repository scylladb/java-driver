...
used exclusively for administrative requests. It shows up in [Node.getOpenConnections](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/metadata/Node.html#getOpenConnections--), as well as
