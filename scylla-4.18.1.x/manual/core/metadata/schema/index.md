...
[session.getMetadata().getKeyspaces()](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/metadata/Metadata.html#getKeyspaces--)

* immutable (must invoke again to observe changes).
* getting notifications:
  [CqlSession.builder().addSchemaChangeListener](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#addSchemaChangeListener-com.datastax.oss.driver.api.core.metadata.schema.SchemaChangeListener-).
* enabling/disabling: `advanced.metadata.schema.enabled` in the configuration, or
  [session.setSchemaMetadataEnabled()](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/session/Session.html#setSchemaMetadataEnabled-java.lang.Boolean-).
...
[Metadata#getKeyspaces](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/metadata/Metadata.html#getKeyspaces--) returns a client-side representation of the database schema:
...
[token map]() of its parent `Metadata` object. Keep in mind that `Metadata` is itself
...
subtype in the package [com.datastax.dse.driver.api.core.metadata.schema](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/metadata/schema/package-frame.html). The objects returned by
...
* [DseFunctionMetadata](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/metadata/schema/DseFunctionMetadata.html): add support for the `DETERMINISTIC` and `MONOTONIC` keywords;
* [DseAggregateMetadata](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/metadata/schema/DseAggregateMetadata.html): add support for the `MONOTONIC` keyword.
...
If it is disabled at startup, [Metadata#getKeyspaces](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/metadata/Metadata.html#getKeyspaces--) will stay empty. If you disable it at runtime,
it will keep the value of the last refresh.

You can achieve the same thing programmatically with [Session#setSchemaMetadataEnabled](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/session/Session.html#setSchemaMetadataEnabled-java.lang.Boolean-): if you call
...
The default configuration (see [reference.conf]()) excludes all
...
[ExecutionInfo#isSchemaInAgreement](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/ExecutionInfo.html#isSchemaInAgreement--):
...
You can also perform an on-demand check at any time with [Session#checkSchemaAgreementAsync](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/session/Session.html#checkSchemaAgreementAsync--) (or
