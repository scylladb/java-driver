...
* getting hold of the [UserDefinedType](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/type/UserDefinedType.html):
...
The driver maps UDT columns to the [UdtValue](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/data/UdtValue.html) class, which exposes getters and setters to access
...
To create a new UDT value, you must first have a reference to its [UserDefinedType](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/type/UserDefinedType.html). There are
...
Note that the driver’s official API does not expose a way to build [UserDefinedType](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/type/UserDefinedType.html) instances
