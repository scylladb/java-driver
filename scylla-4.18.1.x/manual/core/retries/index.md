...
class that implements [RetryPolicy](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/retry/RetryPolicy.html).
...
[RetryVerdict](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/retry/RetryVerdict.html). A retry verdict essentially provides the driver with a [RetryDecision](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/retry/RetryDecision.html) to indicate
...
If the policy rethrows the error, the user code will get an [UnavailableException](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/servererrors/UnavailableException.html). You can inspect
...
If the policy rethrows the error, the user code will get a [ReadTimeoutException](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/servererrors/ReadTimeoutException.html) (do not confuse
this error with [DriverTimeoutException](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/DriverTimeoutException.html), which happens when the coordinator didn’t reply at all to
the client).
...
If the policy rethrows the error, the user code will get a [WriteTimeoutException](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/servererrors/WriteTimeoutException.html).

This method is only invoked for [idempotent]() statements. Otherwise, the driver
...
* if the connection was closed due to an external event. This will manifest as a
  [ClosedConnectionException](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/connection/ClosedConnectionException.html) (network failure) or [HeartbeatException](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/connection/HeartbeatException.html) (missed
  [heartbeat]());
...
Namely, this covers [OverloadedException](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/servererrors/OverloadedException.html), [ServerError](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/servererrors/ServerError.html), [TruncateException](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/servererrors/TruncateException.html),
[ReadFailureException](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/servererrors/ReadFailureException.html) and [WriteFailureException](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/servererrors/WriteFailureException.html).
...
* **any error before a network write was attempted**: to send a query, the driver selects a node,
  borrows a connection from the host’s [connection pool](), and then writes the message
...
* **re-preparing a statement**: when the driver executes a prepared statement, it may find out that
  ...
  detail [here]()). The query is then retried on the same node.
...
* [QueryValidationException](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/servererrors/QueryValidationException.html) and any of its subclasses;
* [FunctionFailureException](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/servererrors/FunctionFailureException.html);
* [ProtocolError](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/servererrors/ProtocolError.html).
