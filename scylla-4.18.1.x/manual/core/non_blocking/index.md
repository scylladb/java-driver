...
such as [Vert.x](https://vertx.io) or [Reactor](https://projectreactor.io), along with tools for automatic detection of blocking calls like
[BlockHound](https://github.com/reactor/BlockHound), has exacerbated this trend even more so.
...
understood as “[lock-free](https://www.baeldung.com/lock-free-programming)”: a program is non-blocking if at least one thread is guaranteed to make
...
The same applies to the methods declared in [`ReactiveSession`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveSession.html) such as [`executeReactive`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveSession.html#executeReactive-com.datastax.oss.driver.api.core.cql.Statement-): the
...
As a consequence, all methods declared in [`ContinuousSession`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/cql/continuous/ContinuousSession.html) and [`ContinuousReactiveSession`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/cql/continuous/reactive/ContinuousReactiveSession.html)
cannot be considered as implemented 100% lock-free, even those built on top of the asynchronous or
reactive APIs like [`executeContinuouslyAsync`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/cql/continuous/ContinuousSession.html#executeContinuouslyAsync-com.datastax.oss.driver.api.core.cql.Statement-) and [`executeContinuouslyReactive`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/cql/continuous/reactive/ContinuousReactiveSession.html#executeContinuouslyReactive-com.datastax.oss.driver.api.core.cql.Statement-). In practice
...
is triggered by a call to [`SessionBuilder.buildAsync()`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#buildAsync--) and happens partially on the calling
...
Similarly, a call to [`SessionBuilder.build()`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#build--) should be considered blocking as it will block the
...
during that phase. Therefore, calls to any method declared in [`AsyncAutoCloseable`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/AsyncAutoCloseable.html), including the
asynchronous ones like [`closeAsync()`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/AsyncAutoCloseable.html#closeAsync--), should also be preferably deferred until the application is
...
For example, [`SafeInitNodeStateListener`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/metadata/SafeInitNodeStateListener.html) is implemented with internal locks for coordination. It
should not be used if strict lock-freedom is enforced.

The same is valid for both built-in [request throttlers](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/session/throttling/RequestThrottler.html):

* `ConcurrencyLimitingRequestThrottler`
* `RateLimitingRequestThrottler`

See the section about [throttling]() for details about these components. Again, they
...
* All built-in implementations of [`TimestampGenerator`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/time/TimestampGenerator.html), upon instantiation;
* The utility method [`Uuids.timeBased()`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/uuid/Uuids.html#timeBased--).
...
usage of native libraries. See the manual sections on [query timestamps]() and
[integration]() for more information.

One component, the codec registry, can block when its [`register`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/type/codec/registry/MutableCodecRegistry.html#register-com.datastax.oss.driver.api.core.type.codec.TypeCodec-) method is called; it is
...
Until driver 4.9, the [`Uuids.random()`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/uuid/Uuids.html#random--) method was a blocking call. Because of that, this method
...
these calls. Thanks to [JAVA-2449](https://datastax-oss.atlassian.net/browse/JAVA-2449), released with driver 4.10.0, `Uuids.random()` became a
...
The driver has a pluggable configuration mechanism built around the [`DriverConfigLoader`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html)
interface. Implementors may choose to support [hot-reloading](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html#supportsReloading--) of configuration files, and the
...
[asynchronous]() API or the developer manual page on
[driver concurrency]() for details.
...
[Reactor](https://projectreactor.io)’s tool for automatic detection of blocking calls, [BlockHound](https://github.com/reactor/BlockHound), is capable of detecting
