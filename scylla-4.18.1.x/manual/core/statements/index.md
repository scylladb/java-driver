...
To execute a CQL query, you  create a [Statement](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/Statement.html) instance and pass it to
...
All statement types share a [common set of execution attributes](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/StatementBuilder.html), that can be set
