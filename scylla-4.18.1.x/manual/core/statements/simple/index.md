...
* create with [SimpleStatement.newInstance()](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/SimpleStatement.html#newInstance-java.lang.String-) or [SimpleStatement.builder()](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/SimpleStatement.html#builder-java.lang.String-).
...
Use [SimpleStatement](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/SimpleStatement.html) for queries that will be executed only once (or just a few times):
...
values, based on their Java type (see the [default type mappings]()).
...
Or you could also use [prepared statements](), which don’t have this limitation since
