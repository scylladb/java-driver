...
* create with [BatchStatement.newInstance()](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/BatchStatement.html#newInstance-com.datastax.oss.driver.api.core.cql.BatchType-) or [BatchStatement.builder()](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/BatchStatement.html#builder-com.datastax.oss.driver.api.core.cql.BatchType-).
* built-in implementation is **immutable**. Setters always return a new object, don’t ignore the
  result.

---

Use [BatchStatement](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/BatchStatement.html) to execute a set of queries as an atomic operation (refer to
[Batching inserts, updates and deletes](http://docs.datastax.com/en/dse/6.7/cql/cql/cql_using/useBatch.html) to understand how to use batching effectively):
