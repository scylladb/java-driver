...
* can also be defined programmatically:
  [CqlSession.builder().withAuthCredentials](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#withAuthCredentials-java.lang.String-java.lang.String-) or
  [CqlSession.builder().withAuthProvider](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#withAuthProvider-com.datastax.oss.driver.api.core.auth.AuthProvider-).
...
You can also write your own provider; it must implement [AuthProvider](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/auth/AuthProvider.html) and declare a public
constructor with a [DriverContext](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/context/DriverContext.html) argument.
...
[ProgrammaticPlainTextAuthProvider](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/auth/ProgrammaticPlainTextAuthProvider.html). The following is equivalent to using `PlainTextAuthProvider` in
the configuration:
...
dumps. If this is not acceptable for you, consider writing your own [AuthProvider](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/auth/AuthProvider.html) implementation;
[PlainTextAuthProviderBase](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/auth/PlainTextAuthProviderBase.html) is a good starting point.

Similarly, [ProgrammaticDseGssApiAuthProvider](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/auth/ProgrammaticDseGssApiAuthProvider.html) lets you configure GSSAPI programmatically:
...
you can subclass [DseGssApiAuthProviderBase](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/auth/DseGssApiAuthProviderBase.html).
...
Instead, use [ProxyAuthentication.executeAs](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/auth/ProxyAuthentication.html#executeAs-java.lang.String-StatementT-) to wrap your query with the correct authorization for
the execution:
