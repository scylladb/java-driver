...
Always double-check the exact LZ4 version needed; you can find it in the driver’s [parent POM](https://search.maven.org/search?q=g:com.datastax.oss%20AND%20a:java-driver-parent&core=gav).
...
which one was chosen, [enable INFO logs]() on the category
...
Always double-check the exact Snappy version needed; you can find it in the driver’s [parent POM](https://search.maven.org/search?q=g:com.datastax.oss%20AND%20a:java-driver-parent&core=gav).
