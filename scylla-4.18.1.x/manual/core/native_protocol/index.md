...
* reading the version:
  [session.getContext().getProtocolVersion()](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/detach/AttachmentPoint.html#getProtocolVersion--).
...
[protocol spec](https://github.com/datastax/native-protocol/tree/1.x/src/main/resources) is available if you’re curious); the most visible aspect is that some features are
...
* [query warnings](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/ExecutionInfo.html#getWarnings--)
* [unset values in bound statements]()
* [custom payloads](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/session/Request.html#getCustomPayload--)

### v4 to v5

* [per-query keyspace]()
* [improved prepared statement resilience]()
