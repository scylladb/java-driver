...
The driver provides built-in support for reactive queries. The [CqlSession](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/CqlSession.html) interface extends
[ReactiveSession](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveSession.html), which adds specialized methods to execute requests expressed in [reactive
...
* The reactive execution model is implemented in a non-blocking fashion: see the manual page on
  [non-blocking programming]() for details.
...
Both methods return a [ReactiveResultSet](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveResultSet.html), which is the reactive streams version of a regular
[ResultSet](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/ResultSet.html). In other words, a `ReactiveResultSet` is a [Publisher](https://www.reactive-streams.org/reactive-streams-1.0.2-javadoc/org/reactivestreams/Publisher.html) for query results.
...
reactive query execution implements [`ReactiveRow`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveRow.html), the reactive equivalent of a
[`Row`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/Row.html).
...
Refer to the javadocs of [`getColumnDefinitions`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveRow.html#getColumnDefinitions--),
