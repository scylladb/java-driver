...
Annotate a DAO method with [@QueryProvider](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/QueryProvider.html) to delegate the execution of the query to one of your
own classes:
...
[@QueryProvider.providerClass()](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/QueryProvider.html#providerClass--) indicates which class to delegate to. The mapper
...
The first constructor argument must always be [MapperContext](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/MapperContext.html). This is a utility type that
provides access to mapper- and DAO-level state. In particular, this is how you get hold of the
session.

If [@QueryProvider.entityHelpers()](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/QueryProvider.html#entityHelpers--) is specified, the constructor must take an
additional [EntityHelper](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/EntityHelper.html) argument for each provided entity class. We specified
...
[@QueryProvider.providerMethod()](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/QueryProvider.html#providerMethod--) indicates which method to invoke on the provider
...
4. Execute the request.
   ...
   `get` extracts a `SensorReading` from a `Row`, so by mapping it to the [ResultSet](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/ResultSet.html) we get back
   the desired [PagingIterable<SensorReading>](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/PagingIterable.html).
