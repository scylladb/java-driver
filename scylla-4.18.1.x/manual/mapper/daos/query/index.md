...
Annotate a DAO method with [@Query](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Query.html) to provide your own query string:
...
* `void`.
* a `boolean` or `Boolean`, which will be mapped to [ResultSet#wasApplied()](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/ResultSet.html#wasApplied--). This is intended for
  conditional queries.
...
* a [Row](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/Row.html). This means the result is not converted, the mapper only extracts the first row of the
...
* an [Optional](https://docs.oracle.com/javase/8/docs/api/java/util/Optional.html) of an entity class. The method will extract the first row and convert
  it, or return `Optional.empty()` if the result set is empty.
* a [ResultSet](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/ResultSet.html). The method will return the raw query result, without any conversion.
* a [BoundStatement](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/BoundStatement.html). This is intended for queries where you will execute this statement later
  or in a batch.
* a [PagingIterable](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/PagingIterable.html). The method will convert each row into an entity instance.
* a [Stream](https://docs.oracle.com/javase/8/docs/api/java/util/stream/Stream.html). The method will convert each row into an entity instance. For details about the
  stream’s characteristics, see [PagingIterable.spliterator](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/PagingIterable.html#spliterator--).
...
* `dao1.queryFromQualifiedTable()` executes `SELECT * FROM t`. In other words, `${qualifiedTableId}`
  ...
  keyspace](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#withKeyspace-com.datastax.oss.driver.api.core.CqlIdentifier-).
