...
Annotate a DAO method with [@SetEntity](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/SetEntity.html) to fill a core driver data structure from an
[Entity]():
...
[SettableByName](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/data/SettableByName.html) (the most likely candidates are [BoundStatement](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/BoundStatement.html), [BoundStatementBuilder](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/BoundStatementBuilder.html) and
[UdtValue](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/data/UdtValue.html)). Note that you can’t use [SettableByName](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/data/SettableByName.html) itself.
...
builders): if the target is a [UdtValue](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/data/UdtValue.html), the driver sends null fields in the serialized form
...
[BoundStatement](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/BoundStatement.html), which is immutable in the driver:
...
If you use a void method with [BoundStatement](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/BoundStatement.html), the mapper processor will issue a compile-time
warning.
