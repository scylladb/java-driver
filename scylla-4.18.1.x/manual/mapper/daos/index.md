...
Interface annotated with [@Dao](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Dao.html).

* interface-level annotations:
  * [@DefaultNullSavingStrategy](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/DefaultNullSavingStrategy.html)
...
* instantiated from a [@DaoFactory](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/DaoFactory.html) method on the mapper.

---

A DAO is an interface that defines a set of query methods. In general, those queries will relate to
the same [entity]() (although that is not a requirement).

It must be annotated with [@Dao](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Dao.html):
...
To obtain a DAO instance, use a [factory method]() on the mapper
interface.
...
[@Dao](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Dao.html).

In addition to inheriting methods from parent interfaces, interface-level annotations such as
[@DefaultNullSavingStrategy](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/DefaultNullSavingStrategy.html) are also inherited:
...
Annotation priority is driven by proximity to the [@Dao](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Dao.html)-annotated interface.  For example:
...
To control how the hierarchy is scanned, annotate interfaces with [@HierarchyScanStrategy](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/HierarchyScanStrategy.html).
