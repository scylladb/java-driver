...
POJO annotated with [@Entity](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Entity.html), must expose a no-arg constructor.

* class-level annotations:
  * [@NamingStrategy](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/NamingStrategy.html)
  * [@CqlName](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/CqlName.html)
  * [@HierarchyScanStrategy](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/HierarchyScanStrategy.html)
  * [@PropertyStrategy](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/PropertyStrategy.html)
* field/method-level annotations:
  * [@PartitionKey](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/PartitionKey.html), [@ClusteringColumn](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/ClusteringColumn.html)
  * [@Computed](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Computed.html)
  * [@Transient](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Transient.html)
  * [@CqlName](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/CqlName.html)
* can inherit annotated fields/methods and [@NamingStrategy](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/NamingStrategy.html). Only use [@Entity](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Entity.html) on concrete
  classes.

---

An entity is a Java class that will be mapped to a Cassandra table or [UDT]().
Entities are used as arguments or return types of [DAO]() methods; they can also be nested
inside other entities (to map UDT columns).

In order to be detected by the mapper, the class must be annotated with [@Entity](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Entity.html):
...
You can switch to an immutable style with the [@PropertyStrategy](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/PropertyStrategy.html) annotation:
...
* the type **must** expose a non-private constructor that takes every
  non-[transient]() property, in the declaration order.
...
You can switch to a “fluent” style (no prefixes) with the [@PropertyStrategy](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/PropertyStrategy.html) annotation:
...
other false positives that you’d like to ignore, mark them as [transient]().
...
For the list of all available conventions, look at the enum constants in [NamingConvention](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/entity/naming/NamingConvention.html).

If you don’t annotate your class with [@NamingStrategy](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/NamingStrategy.html), the mapper defaults to the
...
implementing [NameConverter](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/entity/naming/NameConverter.html):
...
Finally, you can override the CQL name manually with the [@CqlName](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/CqlName.html) annotation:
...
[@PartitionKey](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/PartitionKey.html):
...
Similarly, properties that map to clustering columns must be annotated with [@ClusteringColumn](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/ClusteringColumn.html):
...
[@Select]()’s default behavior is to generate a selection by primary key.

### Computed properties

Annotating an entity property with [@Computed](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Computed.html) indicates that when retrieving data with the mapper
...
[@Computed](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Computed.html) does not support case-sensitivity. If the expression contains case-sensitive column
...
[@Computed](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Computed.html) fields are only used for select-based queries, so they will not be considered for
[@Update](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Update.html) or [@Insert](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Insert.html) operations.

Also note that like all other properties, the expected name in a query result for a [@Computed](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Computed.html)
property is based on the property name and the employed [@NamingStrategy](). You may
override this behavior using [@CqlName]().

Mapping computed results to property names is accomplished using [aliases](http://cassandra.apache.org/doc/latest/cql/dml.html?#aliases).  If you wish to use
entities with [@Computed](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Computed.html) properties with [@GetEntity](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/GetEntity.html) or [@Query](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Query.html)-annotated dao methods, you
...
would expect a [@Query](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Query.html) such as:
...
by the mapper.  In this case, simply annotate these properties with [@Transient](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Transient.html):
...
[@TransientProperties](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/TransientProperties.html) annotation:
...
Override the CQL name manually with [@CqlName](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/CqlName.html), see [User-provided names]()
above.
...
Each concrete class must be annotated with [@Entity](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Entity.html) and abstract classes and interfaces must not
use this annotation.
...
Annotation priority is driven by proximity to the [@Entity](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/Entity.html) class. For example, in the code above
...
To control how the class hierarchy is scanned, annotate classes with [@HierarchyScanStrategy](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/HierarchyScanStrategy.html).
