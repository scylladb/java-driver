...
don’t need to declare that explicitly with [@PropertyStrategy](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/mapper/annotations/PropertyStrategy.html): the mapper detects when it’s
