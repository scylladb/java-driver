...
Here is an example that demonstrates creating a keyspace and a table using [SchemaBuilder](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/querybuilder/SchemaBuilder.html):
...
The [general concepts]() and [non goals]() defined for the query
...
* [keyspace]()
* [table]()
* [index](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/manual/query_builder/schema/index.md)
* [materialized view]()
* [type]()
* [function]()
* [aggregate]()
