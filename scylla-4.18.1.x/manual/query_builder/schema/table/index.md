...
Data in Apache Cassandra is stored in tables.  [SchemaBuilder](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/querybuilder/SchemaBuilder.html) offers API methods for creating,
altering, and dropping tables.

## Creating a Table (CREATE TABLE)

To start a `CREATE TABLE` query, use `createTable` in [SchemaBuilder](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/querybuilder/SchemaBuilder.html):
...
Refer to [CreateTableWithOptions](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/querybuilder/schema/CreateTableWithOptions.html) for the variety of configuration options available.
...
* API methods from [AlterTableWithOptions](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/querybuilder/schema/AlterTableWithOptions.html)
