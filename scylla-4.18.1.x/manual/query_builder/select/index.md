...
Start your SELECT with the `selectFrom` method in [QueryBuilder](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/querybuilder/QueryBuilder.html). There are several variants
