...
To start a DELETE query, use one of the `deleteFrom` methods in [QueryBuilder](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/querybuilder/QueryBuilder.html). There are several
...
You can also create it manually with one of the factory methods in [Selector](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/querybuilder/select/Selector.html), and then pass it to
`selector()`:
