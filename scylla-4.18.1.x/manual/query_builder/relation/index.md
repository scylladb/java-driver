...
You can also create it manually with one of the factory methods in [Relation](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/querybuilder/relation/Relation.html), and then pass it to
`where()`:
...
[term](). The type of relation determines which operators are available.
