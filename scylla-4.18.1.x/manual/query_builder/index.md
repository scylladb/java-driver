...
All the starting methods are centralized in the [QueryBuilder](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/querybuilder/QueryBuilder.html) and [SchemaBuilder](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/querybuilder/SchemaBuilder.html) classes. To get
...
[simple statement]() (or its builder):
...
* favor [bound statements]() for queries that are used often. You can
...
All fluent API methods use [CqlIdentifier](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/CqlIdentifier.html) for schema element names (keyspaces, tables, columns…).
But, for convenience, there are also `String` overloads that take the CQL form (as see [Case
sensitivity]() for more explanations).
...
* statement types:
  ...
  * [DELETE]()
  * [TRUNCATE]()
  * [Schema builder]() (for DDL statements such as CREATE TABLE, etc.)
* common topics:
  * [Relations]()
  * [Conditions]()
  * [Terms]()
