...
lock-freedom are [detailed]() in the core manual.
...
[`SyncCqlSession`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/SyncCqlSession.html%60)), and when calling other synchronous wrapper methods in the public API, for
example, [`ExecutionInfo.getQueryTrace()`](https://java-driver.docs.scylladb.com/scylla-4.18.1.x/api/com/datastax/oss/driver/api/core/cql/ExecutionInfo.html#getQueryTrace--):
