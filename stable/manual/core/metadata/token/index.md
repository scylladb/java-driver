...
[session.getMetadata().getTokenMap()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/metadata/Metadata.html#getTokenMap--)
...
[Metadata#getTokenMap](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/metadata/Metadata.html#getTokenMap--) returns information about the tokens used for data replication. It is used
...
Because token metadata can be disabled, the resulting [TokenMap](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/metadata/TokenMap.html) object is wrapped in an `Optional`;
...
If it is disabled at startup, [Metadata#getTokenMap](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/metadata/Metadata.html#getTokenMap--) will stay empty, and token-aware routing won’t
