...
* programmatically with [Statement.setQueryTimestamp()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/Statement.html#setQueryTimestamp-long-).
...
On some systems, however, it is possible to have a better granularity by using a [JNR](https://github.com/jnr/jnr-posix) call to
[gettimeofday](http://man7.org/linux/man-pages/man2/settimeofday.2.html). This native call will be used when available, unless use of the Java clock is forced
...
You can create your own generator by implementing [TimestampGenerator](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/time/TimestampGenerator.html), and referencing your
...
Client-side timestamps are prohibited for [lightweight transactions](https://docs.datastax.com/en/dse/6.0/cql/cql/cql_using/useInsertLWT.html) (used for conditional updates
