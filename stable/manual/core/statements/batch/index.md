...
Use [BatchStatement](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/cql/BatchStatement.html) to execute a set of queries as an atomic operation (refer to
[Batching inserts, updates and deletes](https://docs.scylladb.com/manual/stable/cql/dml/batch.html) to understand how to use batching effectively):
