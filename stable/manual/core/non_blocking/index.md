...
is triggered by a call to [`SessionBuilder.buildAsync()`](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#buildAsync--) and happens partially on the calling
...
Similarly, a call to [`SessionBuilder.build()`](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#build--) should be considered blocking as it will block the
...
during that phase. Therefore, calls to any method declared in [`AsyncAutoCloseable`](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/AsyncAutoCloseable.html), including the
asynchronous ones like [`closeAsync()`](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/AsyncAutoCloseable.html#closeAsync--), should also be preferably deferred until the application is
...
For example, [`SafeInitNodeStateListener`](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/metadata/SafeInitNodeStateListener.html) is implemented with internal locks for coordination. It
...
See the section about [throttling]() for details about these components. Depending on
...
* All built-in implementations of [`TimestampGenerator`](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/time/TimestampGenerator.html), upon instantiation;
* The utility method [`Uuids.timeBased()`](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/uuid/Uuids.html#timeBased--).
...
One component, the codec registry, can block when its [`register`](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/registry/MutableCodecRegistry.html#register-com.datastax.oss.driver.api.core.type.codec.TypeCodec-) method is called; it is
...
Until driver 4.9, the [`Uuids.random()`](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/uuid/Uuids.html#random--) method was a blocking call. Because of that, this method
...
The driver has a pluggable configuration mechanism built around the [`DriverConfigLoader`](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html)
interface. Implementors may choose to support [hot-reloading](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html#supportsReloading--) of configuration files, and the
