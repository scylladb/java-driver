...
Async driver methods return Java 8’s [CompletionStage](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/CompletionStage.html).
...
Asynchronous methods return instances of the JDK’s [CompletionStage](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/CompletionStage.html), that can be conveniently
...
[AsyncResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/AsyncResultSet.html) that only iterates the current page, the next pages must be fetched explicitly.
