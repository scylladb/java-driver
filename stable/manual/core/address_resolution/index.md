...
* [broadcast_rpc_address](https://docs.datastax.com/en/cassandra/3.x/cassandra/configuration/configCassandra_yaml.html?scroll=configCassandra_yaml__broadcast_rpc_address) (introduced in Cassandra 2.1) is the address to share with clients, if it
...
translation. Write a class that implements [AddressTranslator](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/addresstranslation/AddressTranslator.html) with the following constructor:
