...
We have a full example at [DataStax-Examples/object-mapper-jvm/scala](https://github.com/DataStax-Examples/object-mapper-jvm/tree/master/scala).
...
Case classes are immutable and use the [fluent getter style](), but you
don’t need to declare that explicitly with [@PropertyStrategy](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/PropertyStrategy.html): the mapper detects when it’s
...
See the example’s [build.sbt](https://github.com/DataStax-Examples/object-mapper-jvm/blob/master/scala/build.sbt) for the full details.
