...
Annotate a DAO method with [@Update](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Update.html) to generate a query that updates one or more
[entities]():
...
* `void`.
* a `boolean` or [Boolean](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Boolean.html), which will be mapped to `ResultSet#wasApplied()`. This is intended for
  conditional queries.
  ```java
  @Update(ifExists = true)
  boolean updateIfExists(Product product);
  ```
* a [ResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/cql/ResultSet.html). The method will return the raw query result, without any conversion. This is
  ...
  ```
* a [BoundStatement](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/cql/BoundStatement.html). This is intended for queries where you will execute this statement later or in a batch:
  ```java
  @Update
...
* a [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html) or [CompletableFuture](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletableFuture.html) of any of the above. The mapper will execute the query
  asynchronously.
  Note that for result sets, you need to switch to the asynchronous equivalent [AsyncResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/cql/AsyncResultSet.html).
  ```java
  @Update
