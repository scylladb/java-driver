...
`org.apache.cassandra:java-driver-mapper-runtime`. See [Integration]() for detailed instructions
...
covered in detail in [Configuring the annotation processor]().
...
the same way as the [core driver logs]().
