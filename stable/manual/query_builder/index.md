...
All fluent API methods use [CqlIdentifier](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/CqlIdentifier.html) for schema element names (keyspaces, tables, columns…).
