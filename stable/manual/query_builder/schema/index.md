...
Here is an example that demonstrates creating a keyspace and a table using [SchemaBuilder](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/querybuilder/SchemaBuilder.html):
...
* [keyspace]()
* [table]()
* [index](https://java-driver.docs.scylladb.com/stable/manual/query_builder/schema/index.md)
* [materialized view]()
* [type]()
* [function]()
* [aggregate]()
