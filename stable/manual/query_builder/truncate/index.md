...
To create a TRUNCATE query, use one of the `truncate` methods in [QueryBuilder](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/querybuilder/QueryBuilder.html). There are several
