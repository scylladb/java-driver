...
* [improvement] CASSANDRA-19352: Support native\_transport\_(address|port) + native\_transport\_port\_ssl for DSE 6.8 (4.x edition)
...
* [bug] JAVA-2976: Support missing protocol v5 error codes CAS\_WRITE\_UNKNOWN, CDC\_WRITE\_FAILURE
...
* [bug] JAVA-2925: Consider protocol version unsupported when server requires USE\_BETA flag for it
...
* [new feature] JAVA-2054: Add now\_in\_seconds to protocol v5 query messages
...
* [bug] JAVA-2470: Fix Session.OSS\_DRIVER\_COORDINATES for shaded JAR
...
* [bug] JAVA-2323: Handle restart of a node with same host\_id but a different address
...
* [improvement] JAVA-2090: Add support for additional\_write\_policy and read\_repair table options
...
* [bug] JAVA-1947: Make schema parsing more lenient and allow missing system\_virtual\_schema
...
* [improvement] JAVA-1739: Add host\_id and schema\_version to node metadata
...
* [new feature] JAVA-1647: Handle metadata\_changed flag in protocol v5
...
* [bug] JAVA-1595: Don’t use system.local.rpc\_address when refreshing node list
...
* [improvement] JAVA-1577: Set default consistency level to LOCAL\_ONE
* [bug] JAVA-1548: Retry idempotent statements on READ\_TIMEOUT and UNAVAILABLE
...
* [bug] JAVA-2924: Consider protocol version unsupported when server requires USE\_BETA flag for it.
...
* [new feature] JAVA-2706: Add now\_in\_seconds to protocol v5 query messages.
...
* [improvement] JAVA-2516: Enable hostname validation with Cloud
* [bug] JAVA-2515: NEW\_NODE and REMOVED\_NODE events should trigger ADDED and REMOVED.
...
* [bug] JAVA-1908: TableMetadata.asCQLQuery does not add table option ‘memtable\_flush\_period\_in\_ms’ in the generated query.
...
* [new feature] JAVA-1651: Add NO\_COMPACT startup option.
...
* [improvement] JAVA-1527: Expose host\_id and schema\_version on Host metadata.
...
* [bug] JAVA-1424: Handle new WRITE\_FAILURE and READ\_FAILURE format in v5 protocol.
...
* [improvement] JAVA-1293: Make DecoderForStreamIdSize.MAX\_FRAME\_LENGTH configurable.
...
* [bug] JAVA-1005: DowngradingConsistencyRetryPolicy does not work with EACH\_QUORUM when 1 DC is down.
...
* [improvement] JAVA-1038: Fetch node info by rpc\_address if its broadcast\_address is not in system.peers.
...
* [bug] JAVA-1202: Handle null rpc\_address when checking schema agreement.
...
* [improvement] JAVA-1035: Expose host broadcast\_address and listen\_address if available.
...
* [bug] JAVA-1009: use CL ONE to compute query plan when reconnecting
  control connection.
* [improvement] JAVA-1003: Change default consistency level to LOCAL\_ONE (amends JAVA-926).
...
* [improvement] JAVA-926: Change default consistency level to LOCAL\_QUORUM.
...
* [improvement] JAVA-919: Move crc\_check\_chance out of compressions options.
...
* [bug] JAVA-834: Special case check for ‘null’ string in index\_options column.
...
* [improvement] JAVA-568: Reduce level of logs on missing rpc\_address.
...
* [bug] JAVA-546: Don’t check rpc\_address for control host.
...
* [improvement] JAVA-426: Try next host when we get a SERVER\_ERROR.
...
* [bug] JAVA-428: Do not use a host when no rpc\_address found for it.
...
Merged from 2.0.10\_fixes branch:
...
Merged from 2.0.9\_fixes branch:
...
* [improvement] JAVA-289: Do not hop DC for LOCAL\_\* CL in DCAwareRoundRobinPolicy.
...
* [new] JAVA-207: Add LOCAL\_ONE consistency level support (requires using C\* 2.0.2+).
...
* [api] The 2.0 version is an API-breaking upgrade of the driver. While most
  ...
  and you are encouraged to look at the Upgrade\_guide\_to\_2.0 file that describe
...
* [new] Query parameters defaults (Consistency level, page size, …) can be
  configured globally.
* [new] New Cassandra 2.0 SERIAL and LOCAL\_SERIAL consistency levels are
  supported.
...
* [new] JAVA-142: OSGi bundle.
* [new] JAVA-207: Add support for ConsistencyLevel.LOCAL\_ONE; note that this
...
* [bug] JAVA-77: Fix case where multiple schema changes too quickly wouldn’t work
  (only triggered when 0.0.0.0 was used for the rpc\_address on the Cassandra
  nodes).
