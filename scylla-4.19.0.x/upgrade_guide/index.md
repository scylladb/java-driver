...
We’ve adopted new [API conventions](../manual/api_conventions) to better organize the driver code and make it more modular. As
...
programming](../manual/core/async/) and [paging](../manual/core/paging/).

### CQL to Java type mappings

Since the driver now has access to Java 8 types, some of the [CQL to Java type mappings](../manual/core#cql-to-java-type-mapping) have
changed when it comes to [temporal types](../manual/core/temporal_types) such as `date` and `timestamp`:
