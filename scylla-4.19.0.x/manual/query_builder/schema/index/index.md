...
An index provides a means of expanding the query capabilities of a table.  [SchemaBuilder](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/querybuilder/SchemaBuilder.html) offers
...
To start a `CREATE INDEX` query, use `createIndex` in [SchemaBuilder](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/querybuilder/SchemaBuilder.html):
