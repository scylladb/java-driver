...
their values into a final result, for example average or standard deviation.  [SchemaBuilder](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/querybuilder/SchemaBuilder.html)
offers API methods for creating and dropping aggregates.

## Creating an aggregate (CREATE AGGREGATE)

To start a `CREATE AGGREGATE` query, use `createAggregate` in [SchemaBuilder](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/querybuilder/SchemaBuilder.html):
