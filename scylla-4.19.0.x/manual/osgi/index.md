...
The driver is available as an [OSGi](https://www.osgi.org) bundle.  More specifically, the following maven artifacts are
valid OSGi bundles:
...
In several places of the [driver configuration](../core/configuration) it is possible to specify the class name of
...
by using [withClassLoader()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#withClassLoader-java.lang.ClassLoader-).
...
For example, you can use [DriverConfigLoader.fromDefaults(ClassLoader)](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html#fromDefaults-java.lang.ClassLoader-) to use the driver’s default
...
[DriverConfigLoader.programmaticBuilder(ClassLoader)](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html#programmaticBuilder-java.lang.ClassLoader-):
...
The driver is able to perform native system calls through [JNR](https://github.com/jnr/jnr-posix) in some cases, for example to
...
[JAVA-1127](https://datastax-oss.atlassian.net/browse/JAVA-1127) has been created to track this issue, and there is currently no simple workaround short
