...
Override the CQL name manually with [@CqlName](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/mapper/annotations/CqlName.html), see [User-provided names](#user-provided-names)
above.
