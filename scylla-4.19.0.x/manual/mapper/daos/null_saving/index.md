...
* [SET\_TO\_NULL](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/mapper/entity/saving/NullSavingStrategy.html#SET_TO_NULL): the mapper will always call the setter, even with a null value. The generated code
...
Annotate your [DAO](../../daos/) interface with [@DefaultNullSavingStrategy](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/mapper/annotations/DefaultNullSavingStrategy.html). Any method that does
...
[DO\_NOT\_SET](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/mapper/entity/saving/NullSavingStrategy.html#DO_NOT_SET):
