...
Annotate a DAO method with [@Increment](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/mapper/annotations/Increment.html) to generate a query that updates a counter table that is
mapped to an entity:
...
decapitalized). Alternatively, you may annotate a parameter with [@CqlName](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/mapper/annotations/CqlName.html) to specify the
...
the parameters, they will be ignored (following [NullSavingStrategy#DO\_NOT\_SET](../null_saving/)
...
The method can return `void`, a void [CompletionStage](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/CompletionStage.html) or [CompletableFuture](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/CompletableFuture.html), or a
[ReactiveResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveResultSet.html).
