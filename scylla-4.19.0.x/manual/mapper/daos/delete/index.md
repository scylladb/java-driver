...
Annotate a DAO method with [@Delete](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/mapper/annotations/Delete.html) to generate a query that deletes an [Entity](../../entities):
