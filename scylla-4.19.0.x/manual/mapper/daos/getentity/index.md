...
Annotate a DAO method with [@GetEntity](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/mapper/annotations/GetEntity.html) to convert a core driver data structure into one or more
[Entities](../../entities):
...
* [ResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/ResultSet.html).
* [AsyncResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/AsyncResultSet.html).
...
* a single entity instance. If the argument is a result set type, the generated code will extract
  ...
  ```
* a [PagingIterable](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/PagingIterable.html) of an entity class. In that case, the type of the parameter **must** be
  [ResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/ResultSet.html). Each row in the result set will be converted into an entity instance.
  ```java
  @GetEntity
  PagingIterable<Product> asProducts(ResultSet resultSet);
  ```
* a [Stream](https://docs.oracle.com/javase/8/docs/api/java/util/stream/Stream.html) of an entity class. In that case, the type of the parameter **must** be [ResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/ResultSet.html).
  ...
  ```
* a [MappedAsyncPagingIterable](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/MappedAsyncPagingIterable.html) of an entity class. In that case, the type of the parameter **must**
  be [AsyncResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/AsyncResultSet.html). Each row in the result set will be converted into an entity instance.
  ```java
  @GetEntity
  MappedAsyncPagingIterable<Product> asProducts(AsyncResultSet resultSet);
  ```

If the return type doesn’t match the parameter type (for example [PagingIterable](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/PagingIterable.html) for
[AsyncResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/AsyncResultSet.html)), the mapper processor will issue a compile-time error.
