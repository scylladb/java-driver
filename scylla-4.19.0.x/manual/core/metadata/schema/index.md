...
[session.getMetadata().getKeyspaces()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/metadata/Metadata.html#getKeyspaces--)

* immutable (must invoke again to observe changes).
* getting notifications:
  [CqlSession.builder().addSchemaChangeListener](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#addSchemaChangeListener-com.datastax.oss.driver.api.core.metadata.schema.SchemaChangeListener-).
* enabling/disabling: `advanced.metadata.schema.enabled` in the configuration, or
  [session.setSchemaMetadataEnabled()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/session/Session.html#setSchemaMetadataEnabled-java.lang.Boolean-).
...
[Metadata#getKeyspaces](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/metadata/Metadata.html#getKeyspaces--) returns a client-side representation of the database schema:
...
subtype in the package [com.datastax.dse.driver.api.core.metadata.schema](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/dse/driver/api/core/metadata/schema/package-frame.html). The objects returned by
...
* [DseFunctionMetadata](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/dse/driver/api/core/metadata/schema/DseFunctionMetadata.html): add support for the `DETERMINISTIC` and `MONOTONIC` keywords;
* [DseAggregateMetadata](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/dse/driver/api/core/metadata/schema/DseAggregateMetadata.html): add support for the `MONOTONIC` keyword.
...
See [SchemaChangeListener](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/metadata/schema/SchemaChangeListener.html) for the list of available methods. [SchemaChangeListenerBase](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/metadata/schema/SchemaChangeListenerBase.html) is a
...
If it is disabled at startup, [Metadata#getKeyspaces](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/metadata/Metadata.html#getKeyspaces--) will stay empty. If you disable it at runtime,
it will keep the value of the last refresh.

You can achieve the same thing programmatically with [Session#setSchemaMetadataEnabled](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/session/Session.html#setSchemaMetadataEnabled-java.lang.Boolean-): if you call
...
3. A regex inclusion, enclosed in slashes, for example `"/^Ks.*/"`. The part between the slashes
   must follow the syntax rules of [java.util.regex.Pattern](https://docs.oracle.com/javase/8/docs/api/java/util/regex/Pattern.html). The regex must match the entire
...
<tr>
<td><code>[]</code></td>
<td><code>system</code>, <code>ks1</code>, <code>ks2</code>, <code>data1</code>, <code>data2</code></td>
<td>Include all.</td>
</tr>
<tr>
<td><code>["ks1", "ks2"]</code></td>
<td><code>ks1</code>, <code>ks2</code></td>
<td>Include ks1 and ks2 (recommended, see explanation below).</td>
</tr>
<tr>
<td><code>["!system"]</code></td>
<td><code>ks1</code>, <code>ks2</code>, <code>data1</code>, <code>data2</code></td>
<td>Include all except system.</td>
</tr>
<tr>
<td><code>["/^ks.\*/"]</code></td>
<td><code>ks1</code>, <code>ks2</code></td>
<td>Include all that start with ks.</td>
</tr>
<tr>
<td><code>["!/^ks.\*/"]</code></td>
<td><code>system</code>, <code>data1</code>, <code>data2</code></td>
<td>Exclude all that start with ks (and include everything else).</td>
</tr>
<tr>
<td><code>["system", "/^ks.\*/"]</code></td>
<td><code>system</code>, <code>ks1</code>, <code>ks2</code></td>
<td>Include system, and all that start with ks.</td>
</tr>
<tr>
<td><code>["/^ks.\*/", "!ks2"]</code></td>
<td><code>ks1</code></td>
<td>Include all that start with ks, except ks2.</td>
</tr>
<tr>
<td><code>["!/^ks.\*/", "ks1"]</code></td>
<td><code>system</code>, <code>ks1</code>, <code>data1</code>, <code>data2</code></td>
<td>Exclude all that start with ks, except ks1 (and also include everything else).</td>
</tr>
<tr>
<td><code>["/^s.\*/", /^ks.\*/", "!/.\*2$/"]</code></td>
<td><code>system</code>, <code>ks1</code></td>
<td>Include all that start with s or ks, except if they end with 2.</td>
</tr>
</tbody>
</table>
...
[ExecutionInfo#isSchemaInAgreement](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/ExecutionInfo.html#isSchemaInAgreement--):
...
You can also perform an on-demand check at any time with [Session#checkSchemaAgreementAsync](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/session/Session.html#checkSchemaAgreementAsync--) (or
...
actually agree (see [JAVA-750](https://datastax-oss.atlassian.net/browse/JAVA-750) for the technical details).
