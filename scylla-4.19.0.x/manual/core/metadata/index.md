...
[session.getMetadata()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/session/Session.html#getMetadata--): node states, schema and token map.
...
The driver exposes metadata about the Cassandra cluster via the [Session#getMetadata](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/session/Session.html#getMetadata--) method. It
returns a [Metadata](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/metadata/Metadata.html) object, which contains three types of information:

* [node metadata]()
* [schema metadata]()
* [token metadata]()

Metadata is mostly **immutable** (except for the fields of the [Node](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/metadata/Node.html) class, see the “node metadata”
...
refreshed. See the [Performance]() page for more details.
