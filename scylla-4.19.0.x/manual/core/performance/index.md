...
The driver uses [CqlIdentifier](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/CqlIdentifier.html) to deal with [case sensitivity](../../case_sensitivity). When you
