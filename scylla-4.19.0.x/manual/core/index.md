...
1. [CqlSession](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/CqlSession.html) is the main entry point of the driver. It holds the known state of the actual
...
2. we use `execute` to send a query to Cassandra. This returns a [ResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/ResultSet.html), which is an iterable
   of [Row](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/Row.html) objects. On the next line, we extract the first row (which is the only one in this case);
...
### [CqlSession](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/CqlSession.html)

[CqlSession#builder()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/CqlSession.html#builder--) provides a fluent API to create an instance programmatically. Most of the
...
* via [SessionBuilder.withLocalDatacenter()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#withLocalDatacenter-java.lang.String-);
...
[Row](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/Row.html) provides getters to extract column values; they can be either positional or named:
...
[CqlIdentifier](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/CqlIdentifier.html) is a string wrapper that deals with case-sensitivity. If you don’t want to create an
...
See [AccessibleByName](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/data/AccessibleByName.html) for an explanation of the conversion rules.
...
| duration           | getCqlDuration | [CqlDuration](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/data/CqlDuration.html) | [Temporal types]()     |
...
| tuple              | getTupleValue  | [TupleValue](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/data/TupleValue.html)   | [Tuples]()             |
| user-defined types | getUDTValue    | [UDTValue](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/data/UdtValue.html)       | [User-defined types]() |
| uuid               | getUuid        | java.util.UUID                                                                                                                  |                        |
| varchar            | getString      | java.lang.String                                                                                                                |                        |
| varint             | getBigInteger  | java.math.BigInteger                                                                                                            |                        |
| vector             | getVector      | [CqlVector](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/data/CqlVector.html)     | [Custom Codecs]()      |
...
Use [GenericType](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/type/reflect/GenericType.html) instead:
...
[ResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/ResultSet.html) and [Row](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/Row.html) expose an API to explore the column metadata at runtime:
