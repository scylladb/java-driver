...
| `duration`  | [CqlDuration](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/data/CqlDuration.html) | Custom driver type; can’t be accurately represented by any of the `java.time` types.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
* [TypeCodecs.ZONED_TIMESTAMP_SYSTEM](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/type/codec/TypeCodecs.html#ZONED_TIMESTAMP_SYSTEM): system default;
* [TypeCodecs.ZONED_TIMESTAMP_UTC](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/type/codec/TypeCodecs.html#ZONED_TIMESTAMP_UTC): UTC;
* [TypeCodecs.zonedTimestampAt()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/type/codec/TypeCodecs.html#zonedTimestampAt-java.time.ZoneId-): user-provided.
...
custom type: [CqlDuration](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/data/CqlDuration.html).
