...
The driver uses [SLF4J](https://www.slf4j.org/) as a logging facade. This allows you to plug in your preferred logging
framework (java.util.logging, logback, log4j…) at deployment time.

## Setup

To connect SLF4J to your logging framework, add a [binding](https://www.slf4j.org/manual.html#swapping) JAR in your classpath. If you use a
...
And the same for [Log4J](https://logging.apache.org/log4j):
