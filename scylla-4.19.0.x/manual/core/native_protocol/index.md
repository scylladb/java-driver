...
* reading the version:
  [session.getContext().getProtocolVersion()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/detach/AttachmentPoint.html#getProtocolVersion--).
...
* [query warnings](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/ExecutionInfo.html#getWarnings--)
* [unset values in bound statements]()
* [custom payloads](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/session/Request.html#getCustomPayload--)
