...
* the default implementation is based on the Typesafe Config framework:
  * the driver JAR comes with a [reference.conf](reference/) file that defines the defaults.
...
* the config mechanism can be completely overridden by implementing a set of driver interfaces
  ([DriverConfig](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverConfig.html), [DriverExecutionProfile](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverExecutionProfile.html) and [DriverConfigLoader](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html))
...
Out of the box, the driver uses [Typesafe Config](https://github.com/typesafehub/config).

It looks at the following locations, according to the [standard behavior](https://github.com/typesafehub/config#standard-behavior)
of that library:
...
The driver ships with a [reference.conf](reference/) that defines sensible defaults for all the options. That
...
[HOCON spec](https://github.com/typesafehub/config/blob/master/HOCON.md) for details.
...
* [DriverConfigLoader.fromClasspath](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html#fromClasspath-java.lang.String-): still load from the classpath, but use a different resource
  name. For example “config” will try to load `config.conf`, `config.json` or `config.properties`.
* [DriverConfigLoader.fromFile](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html#fromFile-java.io.File-): load from a file on the local filesystem.
* [DriverConfigLoader.fromUrl](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html#fromUrl-java.net.URL-): load from a URL.
...
Alternatively, you can use [DriverConfigLoader.programmaticBuilder](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html#programmaticBuilder--) to specify configuration options
...
The driver’s context exposes a [DriverConfig](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverConfig.html) instance:
...
[DriverExecutionProfile](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverExecutionProfile.html) has typed option getters:
...
the restrictions explained in [API conventions](../../api_conventions)*.
...
object (refer to the [documentation](https://github.com/typesafehub/config) for more details).
...
Next, you will need to provide your own implementations of [DriverConfig](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverConfig.html) and
[DriverExecutionProfile](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverExecutionProfile.html). Then write a [DriverConfigLoader](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html) and pass it to the session at
...
Where [DriverContext](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/context/DriverContext.html) is the object returned by `session.getContext()`, which allows the policy to
...
First, write an enum that implements [DriverOption](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/config/DriverOption.html):
