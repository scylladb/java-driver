...
translation. Write a class that implements [AddressTranslator](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/addresstranslation/AddressTranslator.html) with the following constructor:
