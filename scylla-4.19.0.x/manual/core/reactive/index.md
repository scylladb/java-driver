...
The driver provides built-in support for reactive queries. The [CqlSession](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/CqlSession.html) interface extends
[ReactiveSession](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveSession.html), which adds specialized methods to execute requests expressed in [reactive
streams](https://en.wikipedia.org/wiki/Reactive_Streams).

Notes:

* Reactive capabilities require the [Reactive Streams API](https://github.com/reactive-streams/reactive-streams-jvm) to be present on the classpath. The
...
Both methods return a [ReactiveResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveResultSet.html), which is the reactive streams version of a regular
[ResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/ResultSet.html). In other words, a `ReactiveResultSet` is a [Publisher](https://www.reactive-streams.org/reactive-streams-1.0.2-javadoc/org/reactivestreams/Publisher.html) for query results.
...
2. Also, note that reactive result sets may emit items to their subscribers on an internal driver IO
   ...
   2.2](https://github.com/reactive-streams/reactive-streams-jvm#2.2) and avoid performing heavy computations or blocking calls inside `onNext` calls, as doing so
...
The examples in this page make usage of [Reactor](https://projectreactor.io/), a popular reactive library, but they should be
...
*nothing has been executed yet*. This is why the write example above uses a `flatMap` operator,
...
Refer to the javadocs of [getColumnDefinitions](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveResultSet.html#getColumnDefinitions--), [getExecutionInfos](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveResultSet.html#getExecutionInfos--) and [wasApplied](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveResultSet.html#wasApplied--) for more
...
reactive query execution implements [`ReactiveRow`](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveRow.html), the reactive equivalent of a
[`Row`](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/Row.html).
...
Refer to the javadocs of [`getColumnDefinitions`](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveRow.html#getColumnDefinitions--),
[`getExecutionInfo`](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveRow.html#getExecutionInfo--) and [`wasApplied`](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/dse/driver/api/core/cql/reactive/ReactiveRow.html#wasApplied--) for
...
driver’s built-in [request throttling](../throttling/) mechanism, although this is usually not required in reactive
applications. See “[Managing concurrency in asynchronous query execution](https://docs.datastax.com/en/devapp/doc/devapp/driverManagingConcurrency.html%5D)” in the Developer Guide
for a few examples.
...
Note that the driver already has a [built-in retry mechanism](../retries/) that can transparently retry failed
