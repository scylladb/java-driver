...
Some driver components need to keep an internal reference to their originating [Session](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/session/Session.html). Under
specific circumstances, they can lose that reference, and you might need to reattach them.

Namely, these components are:

* all [DataType](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/type/DataType.html) instances, in particular [tuples]() and [UDTs]();
* [result rows](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/Row.html), and their [column definitions](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/ColumnDefinition.html).
...
* the [CodecRegistry](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/type/codec/registry/CodecRegistry.html) instance (in case it contains [custom codecs]());
* the [protocol version]() (because the binary format can change across
  versions).
...
Detachable types implement the [Detachable](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/detach/Detachable.html) interface, which has an `isDetached()` method to check
...
* deserializing a previously serialized instance (we’re referring here to [Java serialization](https://docs.oracle.com/javase/tutorial/jndi/objects/serial.html));
...
When an object is detached, it uses a [default codec registry](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/type/codec/registry/CodecRegistry.html#DEFAULT) that only
...
* the binary encoding format is stable across modern protocol versions. The last changes were for
  ...
  the “Changes” section of the [protocol specifications](https://github.com/datastax/native-protocol/tree/1.x/src/main/resources).
