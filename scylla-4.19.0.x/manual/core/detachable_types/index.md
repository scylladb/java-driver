...
* all [DataType](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/type/DataType.html) instances, in particular [tuples](../tuples/) and [UDTs](../udts/);
...
* the [CodecRegistry](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/type/codec/registry/CodecRegistry.html) instance (in case it contains [custom codecs](../custom_codecs/));
