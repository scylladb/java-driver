...
* disabled by default, must enable per statement with [Statement.setTracing()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/Statement.html#setTracing-boolean-) or
  [StatementBuilder.setTracing()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/StatementBuilder.html#setTracing--).
* retrieve with [ResultSet.getExecutionInfo().getTracingId()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/ExecutionInfo.html#getTracingId--) and
  [getQueryTrace()](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/ExecutionInfo.html#getQueryTrace--).
...
[ExecutionInfo](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/ExecutionInfo.html):
...
To get to the details of the trace, retrieve the [QueryTrace](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/QueryTrace.html) instance:
