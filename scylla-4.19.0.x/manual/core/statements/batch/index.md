...
Use [BatchStatement](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/com/datastax/oss/driver/api/core/cql/BatchStatement.html) to execute a set of queries as an atomic operation (refer to
