...
The driver artifacts are published in Maven central, under the group id [com.scylladb](http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22com.scylladb%22); there
...
* [Manual](manual/)
* [API docs](https://java-driver.docs.scylladb.com/scylla-4.19.0.x/api/overview-summary.html)
* Training: [Scylla University](https://university.scylladb.com)
* [Changelog](changelog/)
* [FAQ](faq/)
