...
POJO annotated with [@Entity](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Entity.html), must expose a no-arg constructor.

* class-level annotations:
  * [@NamingStrategy](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/NamingStrategy.html)
  * [@CqlName](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/CqlName.html)
  * [@HierarchyScanStrategy](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/HierarchyScanStrategy.html)
  * [@PropertyStrategy](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/PropertyStrategy.html)
* field/method-level annotations:
  * [@PartitionKey](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/PartitionKey.html), [@ClusteringColumn](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/ClusteringColumn.html)
  * [@Computed](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Computed.html)
  * [@Transient](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Transient.html)
  * [@CqlName](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/CqlName.html)
...
In order to be detected by the mapper, the class must be annotated with [@Entity](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Entity.html):
...
You can switch to an immutable style with the [@PropertyStrategy](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/PropertyStrategy.html) annotation:
...
You can switch to a “fluent” style (no prefixes) with the [@PropertyStrategy](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/PropertyStrategy.html) annotation:
...
For the list of all available conventions, look at the enum constants in [NamingConvention](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/entity/naming/NamingConvention.html).

If you don’t annotate your class with [@NamingStrategy](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/NamingStrategy.html), the mapper defaults to the
...
implementing [NameConverter](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/entity/naming/NameConverter.html):
...
Finally, you can override the CQL name manually with the [@CqlName](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/CqlName.html) annotation:
...
[@PartitionKey](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/PartitionKey.html):
...
Similarly, properties that map to clustering columns must be annotated with [@ClusteringColumn](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/ClusteringColumn.html):
...
Annotating an entity property with [@Computed](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Computed.html) indicates that when retrieving data with the mapper
...
[@Computed](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Computed.html) does not support case-sensitivity. If the expression contains case-sensitive column
...
[@Computed](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Computed.html) fields are only used for select-based queries, so they will not be considered for
[@Update](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Update.html) or [@Insert](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Insert.html) operations.

Also note that like all other properties, the expected name in a query result for a [@Computed](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Computed.html)
property is based on the property name and the employed [@NamingStrategy](). You may
override this behavior using [@CqlName]().

Mapping computed results to property names is accomplished using [aliases](https://docs.scylladb.com/manual/stable/cql/dml/select.html#aliases).  If you wish to use
...
would expect a [@Query](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Query.html) such as:
...
by the mapper.  In this case, simply annotate these properties with [@Transient](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Transient.html):
...
[@TransientProperties](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/TransientProperties.html) annotation:
...
Override the CQL name manually with [@CqlName](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/CqlName.html), see [User-provided names]()
above.
...
Each concrete class must be annotated with [@Entity](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Entity.html) and abstract classes and interfaces must not
use this annotation.
...
Annotation priority is driven by proximity to the [@Entity](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Entity.html) class. For example, in the code above
...
To control how the class hierarchy is scanned, annotate classes with [@HierarchyScanStrategy](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/HierarchyScanStrategy.html).
