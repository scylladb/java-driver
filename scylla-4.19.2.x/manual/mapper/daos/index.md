...
Interface annotated with [@Dao](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Dao.html).

* interface-level annotations:
  * [@DefaultNullSavingStrategy](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/DefaultNullSavingStrategy.html)
...
* instantiated from a [@DaoFactory](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/DaoFactory.html) method on the mapper.
...
It must be annotated with [@Dao](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Dao.html):
...
[@Dao](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Dao.html).

In addition to inheriting methods from parent interfaces, interface-level annotations such as
[@DefaultNullSavingStrategy](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/DefaultNullSavingStrategy.html) are also inherited:
...
Annotation priority is driven by proximity to the [@Dao](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Dao.html)-annotated interface.  For example:
...
To control how the hierarchy is scanned, annotate interfaces with [@HierarchyScanStrategy](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/HierarchyScanStrategy.html).
