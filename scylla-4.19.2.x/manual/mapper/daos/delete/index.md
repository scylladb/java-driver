...
Annotate a DAO method with [@Delete](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/mapper/annotations/Delete.html) to generate a query that deletes an [Entity]():
...
* a `boolean` or `Boolean`, which will be mapped to [ResultSet#wasApplied()](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/cql/ResultSet.html#wasApplied--). This is intended for
  ...
  ```
* a [ResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/cql/ResultSet.html). This is intended for queries with custom IF clauses; when those queries are not
...
* a [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html) or [CompletableFuture](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletableFuture.html) of any of the above. The method will execute the query
  asynchronously. Note that for result sets, you need to switch to [AsyncResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/cql/AsyncResultSet.html).
  ```java
  @Delete
