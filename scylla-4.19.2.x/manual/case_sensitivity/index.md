...
To address this issue, driver 4+ uses a wrapper: [CqlIdentifier](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/CqlIdentifier.html). Its API methods are always
...
* getters and setters of “data container” types [Row](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/cql/Row.html), [UdtValue](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/data/UdtValue.html), and [BoundStatement](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/cql/BoundStatement.html) follow
  special rules described [here](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/data/AccessibleByName.html) (these methods are treated apart because they are
