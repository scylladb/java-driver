...
Use [SimpleStatement](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/cql/SimpleStatement.html) for queries that will be executed only once (or just a few times):
