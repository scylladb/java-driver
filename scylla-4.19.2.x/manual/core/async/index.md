...
Async driver methods return the JDK’s [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html).
...
Asynchronous methods return instances of the JDK’s [CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html), that can be conveniently
...
manual page on [non-blocking programming]() for details.
...
[AsyncResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/cql/AsyncResultSet.html) that only iterates the current page, the next pages must be fetched explicitly.
This greatly simplifies asynchronous paging; see the [paging]()
