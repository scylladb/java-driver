...
The only visible effect is that a request may fail with a [RequestThrottlingException](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/RequestThrottlingException.html), if the
...
requests will fail with an [AllNodesFailedException](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/AllNodesFailedException.html), with the `getErrors()` method returning a
[BusyConnectionException](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/connection/BusyConnectionException.html) for each node. See the [connection pooling]() page.
...
with [BusyConnectionException](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/connection/BusyConnectionException.html) instead of being throttled. The total number of stream ids is a
...
margin. One good way to get this right is to track the `pool.available-streams` [metric]()
...
milliseconds and use the `cql-requests` [metric]() to check the impact on your latencies.
