...
* explicit in the asynchronous API (`session.executeAsync`):
  [AsyncResultSet.hasMorePages()](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/AsyncPagingIterable.html#hasMorePages--) and
  [AsyncResultSet.fetchNextPage()](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/AsyncPagingIterable.html#fetchNextPage--).
* paging state: record the current position and reuse it later (forward only).
* offset queries: emulated client-side with [OffsetPager](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/paging/OffsetPager.html) (**this comes with important performance
...
To avoid this problem, the driver’s asynchronous API now returns a dedicated [AsyncResultSet](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/cql/AsyncResultSet.html);
...
[CompletionStage](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/CompletionStage.html). Here’s an example that prints each row on the command line:
...
[PagingState](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/cql/PagingState.html).
...
codec](), you have to provide a reference to the session when reinjecting the paging
state:
...
queries on the client side: [OffsetPager](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/paging/OffsetPager.html).
...
The [driver examples](https://github.com/scylladb/java-driver/tree/scylla-4.x/examples/src/main/java/com/datastax/oss/driver/examples/paging) include two complete web service implementations demonstrating forward-only
and offset paging.
