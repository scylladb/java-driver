...
* implement the [TypeCodec](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/TypeCodec.html) interface, or use one of the alternative codecs in `ExtraTypeCodecs`.
* registering a codec:
  * at init time: [CqlSession.builder().addTypeCodecs()](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#addTypeCodecs-com.datastax.oss.driver.api.core.type.codec.TypeCodec...-)
  * at runtime:
    ```java
...
are exposed on the [ExtraTypeCodecs](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html) class. In this section we are going to introduce these codecs,
then you will see how to register and use them in the next sections.

### Mapping CQL blobs to Java arrays

The driver default is [TypeCodecs.BLOB](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/TypeCodecs.html#BLOB), which maps CQL `blob` to Java’s [java.nio.ByteBuffer](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/ByteBuffer.html).
Check out our [CQL blob example](https://github.com/scylladb/java-driver/blob/scylla-4.x/examples/src/main/java/com/datastax/oss/driver/examples/datatypes/Blobs.java) to understand how to manipulate the `ByteBuffer` API correctly.

If the `ByteBuffer` API is too cumbersome for you, an alternative is to use
[ExtraTypeCodecs.BLOB_TO_ARRAY](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#BLOB_TO_ARRAY) which maps CQL blobs to Java’s `byte[]`.

### Mapping CQL lists to Java arrays

By default, the driver maps CQL `list` to Java’s [java.util.List](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html). If you prefer to deal with
...
1. For primitive types:
   ...
   |-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|-------------|
   | [ExtraTypeCodecs.BOOLEAN_LIST_TO_ARRAY](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#BOOLEAN_LIST_TO_ARRAY) | `list<boolean>`  | `boolean[]` |
   | [ExtraTypeCodecs.BYTE_LIST_TO_ARRAY](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#BYTE_LIST_TO_ARRAY)       | `list<tinyint>`  | `byte[]`    |
   | [ExtraTypeCodecs.SHORT_LIST_TO_ARRAY](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#SHORT_LIST_TO_ARRAY)     | `list<smallint>` | `short[]`   |
   | [ExtraTypeCodecs.INT_LIST_TO_ARRAY](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#INT_LIST_TO_ARRAY)         | `list<int>`      | `int[]`     |
   | [ExtraTypeCodecs.LONG_LIST_TO_ARRAY](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#LONG_LIST_TO_ARRAY)       | `list<bigint>`   | `long[]`    |
   | [ExtraTypeCodecs.FLOAT_LIST_TO_ARRAY](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#FLOAT_LIST_TO_ARRAY)     | `list<float>`    | `float[]`   |
   | [ExtraTypeCodecs.DOUBLE_LIST_TO_ARRAY](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#DOUBLE_LIST_TO_ARRAY)   | `list<double>`   | `double[]`  |
2. For other types, you should use [ExtraTypeCodecs.listToArrayOf(TypeCodec)](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#listToArrayOf-com.datastax.oss.driver.api.core.type.codec.TypeCodec-); for example, to map
...
By default, the driver maps CQL `timestamp` to Java’s [java.time.Instant](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Instant.html) (using
[TypeCodecs.TIMESTAMP](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/TypeCodecs.html#TIMESTAMP)). This is the most natural mapping, since neither type contains any time zone
...
In either case, you can pick the time zone that the codec will use for its [format()](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/TypeCodec.html#format-JavaTypeT-) and [parse()](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/TypeCodec.html#parse-java.lang.String-)
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|-------------|----------------------------------------------|
| [TypeCodecs.TIMESTAMP](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/TypeCodecs.html#TIMESTAMP)                                                     | `timestamp` | `Instant`   | System default                               |
| [ExtraTypeCodecs.TIMESTAMP_UTC](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#TIMESTAMP_UTC)                                   | `timestamp` | `Instant`   | UTC                                          |
| [ExtraTypeCodecs.timestampAt(ZoneId)](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#timestampAt-java.time.ZoneId-)             | `timestamp` | `Instant`   | User-provided                                |
| [ExtraTypeCodecs.TIMESTAMP_MILLIS_SYSTEM](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#TIMESTAMP_MILLIS_SYSTEM)               | `timestamp` | `long`      | System default                               |
| [ExtraTypeCodecs.TIMESTAMP_MILLIS_UTC](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#TIMESTAMP_MILLIS_UTC)                     | `timestamp` | `long`      | UTC                                          |
| [ExtraTypeCodecs.timestampMillisAt(ZoneId)](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#timestampMillisAt-java.time.ZoneId-) | `timestamp` | `long`      | User-provided                                |
...
the driver to map `timestamp` to [java.time.ZonedDateTime](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/ZonedDateTime.html) with a fixed zone. Use one of the
following codecs:

| Codec                                                                                                                                                                                                     | CQL type    | Java type       | Time zone used by all codec operations   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|-----------------|------------------------------------------|
| [ExtraTypeCodecs.ZONED_TIMESTAMP_SYSTEM](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#ZONED_TIMESTAMP_SYSTEM)               | `timestamp` | `ZonedDateTime` | System default                           |
| [ExtraTypeCodecs.ZONED_TIMESTAMP_UTC](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#ZONED_TIMESTAMP_UTC)                     | `timestamp` | `ZonedDateTime` | UTC                                      |
| [ExtraTypeCodecs.zonedTimestampAt(ZoneId)](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#zonedTimestampAt-java.time.ZoneId-) | `timestamp` | `ZonedDateTime` | User-provided                            |
...
date-times, then you probably would like the driver to map timestamps to [java.time.LocalDateTime](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/LocalDateTime.html)
obtained from a fixed zone. Use one of the following codecs:

| Codec                                                                                                                                                                                                     | CQL type    | Java type       | Time zone used by all codec operations   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|-----------------|------------------------------------------|
| [ExtraTypeCodecs.LOCAL_TIMESTAMP_SYSTEM](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#LOCAL_TIMESTAMP_SYSTEM)               | `timestamp` | `LocalDateTime` | System default                           |
| [ExtraTypeCodecs.LOCAL_TIMESTAMP_UTC](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#LOCAL_TIMESTAMP_UTC)                     | `timestamp` | `LocalDateTime` | UTC                                      |
| [ExtraTypeCodecs.localTimestampAt(ZoneId)](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#localTimestampAt-java.time.ZoneId-) | `timestamp` | `LocalDateTime` | User-provided                            |
...
holds the [zone id](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/ZoneId.html).

If you follow this guideline, then you can use [ExtraTypeCodecs.ZONED_TIMESTAMP_PERSISTED](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#ZONED_TIMESTAMP_PERSISTED) to map
the CQL tuple to [java.time.ZonedDateTime](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/ZonedDateTime.html).
...
If you prefer to deal with [java.util.Optional](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html) in your application instead of nulls, then you can
use [ExtraTypeCodecs.optionalOf(TypeCodec)](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#optionalOf-com.datastax.oss.driver.api.core.type.codec.TypeCodec-):
...
collection references, this codec will also map empty collections to [Optional.empty()](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#empty--).

### Mapping Java Enums

Java [Enums](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Enum.html) can be mapped to CQL in two ways:

1. By name: [ExtraTypeCodecs.enumNamesOf(Class)](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#enumNamesOf-java.lang.Class-) will create a codec for a given `Enum` class that
   maps its constants to their [programmatic names](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Enum.html#name--). The corresponding CQL column must be
   of type `text`. Note that this codec relies on the enum constant names; it is therefore vital that
   enum names never change.
2. By ordinal: [ExtraTypeCodecs.enumOrdinalsOf(Class)](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#enumOrdinalsOf-java.lang.Class-) will create a codec for a given `Enum` class
   that maps its constants to their [ordinal value](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Enum.html#ordinal--). The corresponding CQL column must
   be of type `int`.
   ...
   **We strongly recommend against this approach.** It is provided for compatibility with driver 3,
   ...
   implement a codec with [MappingCodec](),
...
Jackson library. The method [ExtraTypeCodecs.json(Class)](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#json-java.lang.Class-) will create a codec for a given Java class
that maps instances of that class to Json strings, using a newly-allocated, default [ObjectMapper](http://fasterxml.github.io/jackson-databind/javadoc/2.10/com/fasterxml/jackson/databind/ObjectMapper.html).
It is also possible to pass a custom `ObjectMapper` instance using [ExtraTypeCodecs.json(Class,
ObjectMapper)](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#json-java.lang.Class-com.fasterxml.jackson.databind.ObjectMapper-) instead.
...
| Codec                                                                                                                                                                                         | CQL type        | Java type   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|-------------|
| [ExtraTypeCodecs.floatVectorToArray(int)](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/ExtraTypeCodecs.html#floatVectorToArray-int-) | `vector<float>` | `float[]`   |
...
To write a custom codec, implement the [TypeCodec](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/TypeCodec.html) interface. Here is an example that maps a CQL
...
* which methods to override. Refer to the [TypeCodec](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/TypeCodec.html) javadocs for additional information about each
  of them;
* how to piggyback on a built-in codec, in this case `TypeCodecs.INT`. Very often, this is the best
  ...
  [built-in codec implementations](https://github.com/scylladb/java-driver/tree/scylla-4.x/core/src/main/java/com/datastax/oss/driver/internal/core/type/codec).
...
Type tokens are instances of [GenericType](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/reflect/GenericType.html). They are immutable and thread-safe, you should store
...
The above example, `CqlIntToStringCodec`, could be rewritten to leverage [MappingCodec](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/MappingCodec.html), an abstract
...
The driver stores all codecs (built-in and custom) in an internal [CodecRegistry](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/registry/CodecRegistry.html):
