...
[session.getMetadata().getNodes()](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/metadata/Metadata.html#getNodes--): all nodes known to the driver (even if not
actively connected).

* [Node](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/metadata/Node.html) instances are mutable, the fields will update in real time.
* getting notifications:
  [CqlSession.builder().addNodeStateListener](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/session/SessionBuilder.html#addNodeStateListener-com.datastax.oss.driver.api.core.metadata.NodeStateListener-).

---

[Metadata#getNodes](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/metadata/Metadata.html#getNodes--) returns all the nodes known to the driver when the metadata was retrieved; this
...
retrieved. On the other hand, the [Node](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/metadata/Node.html) object is mutable; you can hold onto an instance across
...
[Node#getDistance()](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/metadata/Node.html#getDistance--) is set by the load balancing policy. The driver does not connect to `IGNORED`
...
[Node#getExtras()](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/metadata/Node.html#getExtras--) contains additional free-form properties. This is intended for future evolution
or custom driver extensions. In particular, if the driver is connected to DataStax Enterprise, the
map will contain additional information under the keys defined in [DseNodeProperties](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/dse/driver/api/core/metadata/DseNodeProperties.html):
