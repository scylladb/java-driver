...
To start an UPDATE query, use one of the `update` methods in [QueryBuilder](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/querybuilder/QueryBuilder.html). There are several
...
You can also create it manually with one of the factory methods in [Assignment](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/querybuilder/update/Assignment.html), and then pass it to
`set()`:
