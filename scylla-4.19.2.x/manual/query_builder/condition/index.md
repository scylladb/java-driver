...
You can also create it manually with one of the factory methods in [Condition](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/querybuilder/condition/Condition.html), and then pass it to
`if_()`:
