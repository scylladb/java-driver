...
* as an argument to some selectors, for example the indices of [sub-element]()
  selectors;
* as the right operand of [relations]().

To create a term, call one of the factory methods in [QueryBuilder](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/querybuilder/QueryBuilder.html):
...
[default type mappings](). If there is no default mapping, you
will get a `CodecNotFoundException`.

If you use [custom codecs](), you might need to inline a custom Java type.
You can pass a [CodecRegistry](https://java-driver.docs.scylladb.com/scylla-4.19.2.x/api/com/datastax/oss/driver/api/core/type/codec/registry/CodecRegistry.html) as the second argument (most likely, this will be the registry of
your session):
