...
default retry policy**: see the [manual]() to understand how to use it.
...
Thanks to [JAVA-2900](https://datastax-oss.atlassian.net/browse/JAVA-2900), an equivalent retry policy with downgrading behavior was re-introduced in
...
[examples repository](https://github.com/scylladb/java-driver/blob/scylla-4.x/examples/src/main/java/com/datastax/oss/driver/examples/retry/DowngradingRetry.java).
...
If you are using a driver version >= 4.10.0, read the [manual]() to
...
metadata; see the [performance]() page.
