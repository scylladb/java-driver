...
connection, as it is based upon the [*Native protocol*](),
...
necessary most of the time except for very [specific use cases]().
...
driver* provides. Please see [this link]()
...
in the [Load balaning policies docs]().
...
in the [“Queries and Results” section]().
...
documentation about the classes needed is [available there]().
...
If one still wishes to change those, first [Monitoring the pools]() is
advised, then a [deep dive in the Pools management mechanism]() should
