...
1. the [Cluster](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Cluster.html) object is the main entry point of the driver. It holds the known state of the actual Cassandra cluster
...
2. the [Session](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Session.html) is what you use to execute queries. Likewise, it is thread-safe and should be reused;
3. we use `execute` to send a query to Cassandra. This returns a [ResultSet](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/ResultSet.html), which is essentially a collection of [Row](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Row.html)
...
### [Cluster](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Cluster.html)

#### Creating an instance

The simplest approach is to do it programmatically with [Cluster.Builder](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Cluster.Builder.html), which provides a fluent API:
...
service). You’ll need to provide an implementation of [Initializer](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Cluster.Initializer.html) that loads these settings:
...
* [load balancing]();
* [metrics]();
* low-level [Netty configuration](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/NettyOptions.html);
* [query options](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/QueryOptions.html);
* [reconnections]();
* [retries]();
* [socket options]();
* [SSL]();
...
In addition, you can register various types of listeners to be notified of cluster events; see [Host.StateListener](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Host.StateListener.html),
[LatencyTracker](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/LatencyTracker.html), and [SchemaChangeListener](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/SchemaChangeListener.html).
...
* try to connect to each of the contact points in sequence. The order is not deterministic (in fact, the driver shuffles
  ...
  a [NoHostAvailableException](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/exceptions/NoHostAvailableException.html) is thrown and the process stops here;
...
### [Session](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Session.html)
...
Executing a query produces a [ResultSet](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/ResultSet.html), which is an iterable of [Row](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Row.html). The basic way to process all rows is to use
...
[Row](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Row.html) provides getters to extract column values; they can be either positional or named:
...
<table border="1" style="text-align:center; width:100%;margin-bottom:1em;">
    ...
    <tr> <td>date</td> <td>getDate</td> <td><a href="https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/LocalDate.html">LocalDate</a></td> </tr>
...
[Object Mapper]() to simplify retrieval & store of your data.
