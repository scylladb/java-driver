...
The base class to configure SSL is [RemoteEndpointAwareSSLOptions](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/RemoteEndpointAwareSSLOptions.html). It’s very generic, but
...
configure SSL programmatically with [RemoteEndpointAwareJdkSSLOptions](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/RemoteEndpointAwareJdkSSLOptions.html):
...
[newSSLEngine(SocketChannel,InetSocketAddress)](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/RemoteEndpointAwareJdkSSLOptions.html#newSSLEngine-io.netty.channel.socket.SocketChannel-java.net.InetSocketAddress-) if you need specific
...
[RemoteEndpointAwareNettySSLOptions](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/RemoteEndpointAwareNettySSLOptions.html) allows you to use Netty’s `SslContext` instead of
