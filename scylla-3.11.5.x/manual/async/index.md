...
Guava’s [ListenableFuture](https://github.com/google/guava/wiki/ListenableFutureExplained), that can be conveniently chained and
composed.
...
To avoid this, use [getAvailableWithoutFetching](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/ResultSet.html#getAvailableWithoutFetching--) to limit the iteration
to the current page, and [fetchMoreResults](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/ResultSet.html#fetchMoreResults--) to get a future to the next
...
* [Cluster#init](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Cluster.html#init--) performs blocking I/O operations. To avoid
...
* trying to read fields from a [query trace](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/QueryTrace.html) will block if the trace
