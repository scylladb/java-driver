...
Use [SimpleStatement](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/SimpleStatement.html) for queries that will be executed only once (or a few times) in your application:
...
[prepared statements]()) is an even worse
...
based on their Java type (see the [default type mappings]()). This can be tricky, in
