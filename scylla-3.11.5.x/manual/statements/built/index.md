...
Built statements are generated via [QueryBuilder](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/querybuilder/QueryBuilder.html)’s Fluent API.  Use of Fluent API allows
...
[QueryBuilder](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/querybuilder/QueryBuilder.html)’s methods that represent the CQL’s “verb”: `select`, `update`, `delete`,
...
a [TableMetadata](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TableMetadata.html) object.

Note: The `QueryBuilder` doesn’t provide support for the full set of CQL.  For
most of DDL operations (`CREATE TABLE`, etc.) you can use the [SchemaBuilder](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/schemabuilder/SchemaBuilder.html).  To perform other
...
[specifying](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/querybuilder/QueryBuilder.html#cast-java.lang.Object-com.datastax.driver.core.DataType-)
...
`QueryBuilder`’s
[functions](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/querybuilder/QueryBuilder.html#eq-java.lang.Iterable-java.lang.Iterable-),
...
`remove`, `setIdx`, etc.  For the full list of operations, see the [QueryBuilder](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/querybuilder/QueryBuilder.html)’s documentation.
