...
* the driver writes a request containing the stream id and the query on
  ...
  back a [ResultSetFuture](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/ResultSetFuture.html)).
...
not ignored by the [load balancing policy]()).
...
Connections pools are configured with a [PoolingOptions](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/PoolingOptions.html) object, which
...
by your [LoadBalancingPolicy](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/policies/LoadBalancingPolicy.html), and will generally indicate whether a
...
[PoolingOptions.setNewConnectionThreshold](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/PoolingOptions.html#setNewConnectionThreshold-com.datastax.driver.core.HostDistance-int-) determines the threshold
...
(n - 1) \* 128 + [PoolingOptions.setNewConnectionThreshold](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/PoolingOptions.html#setNewConnectionThreshold-com.datastax.driver.core.HostDistance-int-)
...
[PoolingOptions.setIdleTimeoutSeconds](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/PoolingOptions.html#setIdleTimeoutSeconds-int-)), trashed connections are closed
...
[PoolingOptions.setMaxRequestsPerConnection](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/PoolingOptions.html#setMaxRequestsPerConnection-com.datastax.driver.core.HostDistance-int-) allows you to
...
[SocketOptions.readTimeoutMillis](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/SocketOptions.html#getReadTimeoutMillis--):
...
Two options control that queue: a maximum size ([PoolingOptions.setMaxQueueSize](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/PoolingOptions.html#setMaxQueueSize-int-)) and a timeout
([PoolingOptions.setPoolTimeoutMillis](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/PoolingOptions.html#setPoolTimeoutMillis-int-)).
...
If the attempt is rejected, the driver will move to the next host in the [query plan](),
and try to acquire a connection again.

If all hosts are busy with a full queue, the request will fail with a
[NoHostAvailableException](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/exceptions/NoHostAvailableException.html). If you inspect the map returns by this
exception’s [getErrors](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/exceptions/NoHostAvailableException.html#getErrors--) method, you will see a [BusyPoolException](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/exceptions/BusyPoolException.html) for
each host.

## Monitoring and tuning the pool

The easiest way to monitor pool usage is with [Session.getState](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Session.html#getState--). Here’s
...
* set core = max;
* keep core = 1, but adjust [maxRequestsPerConnection](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/PoolingOptions.html#setMaxRequestsPerConnection-com.datastax.driver.core.HostDistance-int-) and
  [newConnectionThreshold](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/PoolingOptions.html#setNewConnectionThreshold-com.datastax.driver.core.HostDistance-int-) so that enough connections are added by
