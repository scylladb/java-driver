...
The driver maps UDT columns to the [UDTValue](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/UDTValue.html) class, which exposes getters and setters to access
...
To create a new UDT value, you must first have a reference to its [UserType](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/UserType.html). There are
...
Note that the driver’s official API does not expose a way to build [UserType](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/UserType.html) instances manually.
