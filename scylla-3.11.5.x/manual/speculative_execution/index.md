...
If a query is [not idempotent](), the driver will never schedule speculative executions for it, because
...
[SpeculativeExecutionPolicy](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/policies/SpeculativeExecutionPolicy.html) provided when initializing the
...
### [ConstantSpeculativeExecutionPolicy](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/policies/ConstantSpeculativeExecutionPolicy.html)
...
### [PercentileSpeculativeExecutionPolicy](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/policies/PercentileSpeculativeExecutionPolicy.html)

This policy sets the threshold at a given latency percentile for the
current host, based on recent statistics.

First and foremost, make sure that the [HdrHistogram](http://hdrhistogram.github.io/HdrHistogram/) library (used
...
Then create a [PercentileTracker](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/PercentileTracker.html) that will collect latency histograms for your `Cluster`. Two
implementations are provided out of the box:

* [ClusterWidePercentileTracker](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/ClusterWidePercentileTracker.html): maintains a single histogram for the whole cluster. This means
  queries will be compared against the global performance of all the hosts in the cluster.
* [PerHostPercentileTracker](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/PerHostPercentileTracker.html): maintains a histogram per host. This means queries to a host will
...
Turning speculative executions on doesn’t change the driver’s [retry]() behavior. Each
...
[cluster.getMetrics().getErrors().getSpeculativeExecutions()](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Metrics.Errors.html#getSpeculativeExecutions--)).
It should only be a few percents of the total number of requests
([cluster.getMetrics().getRequestsTimer().getCount()](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Metrics.html#getRequestsTimer--)).
...
([Session.getState().getOpenConnections(host)](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Session.State.html)) against
...
[cluster.getConfiguration().getProtocolOptions().getProtocolVersion()](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/ProtocolOptions.html#getProtocolVersion--).
