...
First, create a [MappingManager](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/MappingManager.html). It wraps an existing [Session](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Session.html)
instance:
...
[Mapper](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/Mapper.html) object. You obtain this object from the `MappingManager`:
...
[Result](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/Result.html) is similar to `ResultSet` but for a given mapped class.
...
With named markers, use [@Param](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/Param.html) to indicate which parameter
...
query with the annotation [@QueryParameters](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/QueryParameters.html). Then, options like
...
[MappingConfiguration](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/MappingConfiguration.html) lets you configure low-level aspects of the object mapper. It is configured
...
The main component in the configuration is [PropertyMapper](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/PropertyMapper.html), which controls how annotated classes
will relate to database objects. The best way to plug in specific behavior is to create an instance of
[DefaultPropertyMapper](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/DefaultPropertyMapper.html) and customize it.
