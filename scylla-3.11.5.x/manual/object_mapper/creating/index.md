...
It is annotated with [@Table](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/Table.html):
...
- `caseSensitiveKeyspace`: whether the keyspace name is [case-sensitive](http://docs.datastax.com/en/cql/3.3/cql/cql_reference/ucase-lcase_r.html).
- `caseSensitiveTable`: whether the table name is [case-sensitive](http://docs.datastax.com/en/cql/3.3/cql/cql_reference/ucase-lcase_r.html).
- `readConsistency`: the [consistency level](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/ConsistencyLevel.html) that will be used on each
  get operation in the mapper. (if unspecified, it defaults to the
  cluster-wide setting)
- `writeConsistency`: the [consistency level](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/ConsistencyLevel.html) that will be used on each
...
the mapper access to it via [reflection](https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/AccessibleObject.html#setAccessible-boolean-).
...
[Java bean property](https://docs.oracle.com/javase/tutorial/javabeans/writing/properties.html). *Annotations on setters are not
supported and will be silently ignored by the mapper*.
...
2. The security manager, if any, grants the mapper access to it via [reflection](https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/AccessibleObject.html#setAccessible-boolean-).

Note that, according to the [Java Beans specification](https://docs.oracle.com/javase/tutorial/javabeans/writing/properties.html), a setter
...
column of the same name. *The mapping is case-insensitive by default*,
i.e., the property `userId` would map to a column named `userid`.

If you want to use a different name, or [case-sensitive](http://docs.datastax.com/en/cql/3.3/cql/cql_reference/ucase-lcase_r.html) names,
use the [@Column](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/Column.html) annotation.
...
[@PartitionKey](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/PartitionKey.html) and [@ClusteringColumn](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/ClusteringColumn.html) are used to indicate the
[partition key](http://thelastpickle.com/blog/2013/01/11/primary-keys-in-cql.html) and [clustering columns](http://thelastpickle.com/blog/2013/01/11/primary-keys-in-cql.html). In the case of a
...
[@Computed](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/Computed.html) can be used on properties that are the result of a
...
Support in [accessors]() is planned for a future
version (see
...
to table columns. [@Transient](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/Transient.html) can be used to prevent a field or
...
[User-Defined Types] can also be mapped by using [@UDT](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/UDT.html):
...
use the [@Field](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/Field.html) annotation:
...
types and all [user types]() previously defined is
the database.
...
The default annotation is [@Frozen](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/Frozen.html), [@FrozenKey](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/FrozenKey.html) and
[@FrozenValue](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/FrozenValue.html) are also provided for convenience:
...
To work around this, one may use [udtCodec](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/MappingManager.html#udtCodec-java.lang.Class-) to register a `TypeCodec` that the mapper can use
...
See [Freezing collection types](https://docs.datastax.com/en/dse/6.7/cql/cql/cql_using/refCollectionType.html) for more information about the frozen keyword.
