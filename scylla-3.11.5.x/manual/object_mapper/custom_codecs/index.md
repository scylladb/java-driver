...
The mapper can take advantage of [custom codecs]()
...
Instead, reference the codec’s class in the [@Column](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/Column.html)
annotation:
...
This also works with [@Field](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/Field.html) and [@Param](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/mapping/annotations/Param.html) annotations.
