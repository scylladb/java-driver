...
[ResultSet](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/ResultSet.html) interface provides the following methods:
...
To do so, the driver exposes a [PagingState](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/PagingState.html) object that represents
...
portable across [native protocol]() versions. This
...
Note: because of [CASSANDRA-10880](https://issues.apache.org/jira/browse/CASSANDRA-10880), paging states are also incompatible
...
* [ExecutionInfo#getPagingStateUnsafe()](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/ExecutionInfo.html#getPagingStateUnsafe--)
* [Statement#setPagingStateUnsafe(byte[])](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Statement.html#setPagingStateUnsafe-byte:A-)
