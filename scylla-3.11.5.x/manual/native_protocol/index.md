...
Cassandra codebase](https://github.com/apache/cassandra/tree/trunk/doc) if you’re curious); the most visible
...
[ProtocolOptions#getProtocolVersion()](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/ProtocolOptions.html#getProtocolVersion--):
...
* bound variables in simple statements
  ([Session#execute(String, Object…)](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/Session.html#execute-java.lang.String-java.lang.Object...-))
* [batch statements](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/BatchStatement.html)
* [query paging]()
...
* the number of stream ids per connection goes from 128 to 32768 (see
  [Connection pooling]())
* [serial consistency on batch statements](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/BatchStatement.html#setSerialConsistencyLevel-com.datastax.driver.core.ConsistencyLevel-)
