...
* Ability to map CQL timestamp, date and time columns to Java 8 or Joda Time classes (rather than the built-in mappings for Date, [LocalDate](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/LocalDate.html) and Long);
...
of [optional codecs]() that might fit your needs.

## Overview of the serialization mechanism

The central piece in the serialization mechanism is [TypeCodec](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TypeCodec.html).
...
* [Serialize](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TypeCodec.html#serialize-T-com.datastax.driver.core.ProtocolVersion-) a Java object into a CQL value;
* [Deserialize](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TypeCodec.html#deserialize-java.nio.ByteBuffer-com.datastax.driver.core.ProtocolVersion-) a CQL value into a Java object;
* [Format](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TypeCodec.html#format-T-) a Java object into a CQL literal;
* [Parse](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TypeCodec.html#parse-java.lang.String-) a CQL literal into a Java object.
...
Refer to the [javadocs](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TypeCodec.html) of `TypeCodec` for more information.

`TypeCodec`s are centralized in a [CodecRegistry](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/CodecRegistry.html) instance.
...
Refer to the [javadocs](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/CodecRegistry.html) of `CodecRegistry` for more information.
...
the driver to automatically map that column to a Java object using the [Jackson](https://github.com/FasterXML/jackson) library,
...
Custom codecs also work with the driver’s [object mapper]().
...
* [UserType](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/UserType.html) instances are automatically mapped to [UDTValue](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/UDTValue.html) objects. All registered codecs are available recursively to the UDT’s fields;
* [TupleType](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TupleType.html) instances are automatically mapped to [TupleValue](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TupleValue.html) objects (with the same rules for nested fields);
* [CustomType](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/DataType.CustomType.html) instances are automatically mapped to [ByteBuffer](http://docs.oracle.com/javase/8/docs/api/java/nio/ByteBuffer.html) instances.
...
If the codec registry encounters a mapping that it can’t handle automatically, a [CodecNotFoundException](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/exceptions/CodecNotFoundException.html)
is thrown.
...
By default, the driver maps user-defined type values to [UDTValue](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/UDTValue.html) instances.
...
Java generic (parameterized) types are fully supported, through Guava’s [TypeToken](https://google.github.io/guava/releases/19.0/api/docs/com/google/common/reflect/TypeToken.html) API.
...
2. otherwise, the registry checks the list of “basic” codecs: the default ones,
   ...
   It calls each codec’s [accepts](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TypeCodec.html#accepts-com.datastax.driver.core.DataType-) methods to determine if it can handle the mapping,
...
5. otherwise, the registry throws [CodecNotFoundException](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/exceptions/CodecNotFoundException.html).
...
* With [SimpleStatement](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/SimpleStatement.html) instances;
* With [BuiltStatement](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/querybuilder/BuiltStatement.html) instances (created via the Query Builder).
