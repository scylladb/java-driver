...
The driver exposes a special [`TupleValue`](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TupleValue.html) class to handle such columns.
[`TupleValue`](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TupleValue.html) exposes getters allowing to extract from the tuple all the data types
...
will need to create or gather a [`TupleType`](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TupleType.html) first, in order to be able to create a [`TupleValue`](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TupleValue.html)
to bind:
...
The method [`newValue(Object...)`](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TupleType.html#newValue-java.lang.Object...-) follows the same rules as `new SimpleStatement(String, Object...)`;
...
To avoid such ambiguities, a [`TupleValue`](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TupleValue.html) returned by [`newValue()`](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TupleType.html#newValue--) also exposes specific
...
Users can also define single-usage tuples in *SELECT* queries with the `IN` keyword
...
[`TupleValue`](https://java-driver.docs.scylladb.com/scylla-3.11.5.x/api/com/datastax/driver/core/TupleValue.html) with the Java driver:
