...
* a [page]() from a result set, i.e. a list of serialized
  rows.
...
[parent POM](https://repo1.maven.org/maven2/com/scylladb/scylla-driver-parent/3.11.5.0/scylla-driver-parent-3.11.5.0.pom) (change the URL to match your driver version) and look
