...
## Migrating from Java Driver 3.x
...
The driver uses this extension point for reactive CQL execution. You can also take advantage of it
to plug your own request types (if you're interested, take a look at
